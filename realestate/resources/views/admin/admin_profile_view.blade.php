                ...
                <div class="card rounded">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div>
                                <!-- Imprimir la foto del Perfil del usuario -->
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted">
                                {{ !empty($profileData->address) ? $profileData->address : 'No Direction!' }}</p>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted">www.josueivanmelojaramillo.com</p>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.profile.store') }}" class="forms-sample"
                                ...
                                <div class="mb-3">
                                    <label for="email" class="form-label">Em@il</label>
